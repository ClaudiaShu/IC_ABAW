...
def get_model_by_name(model_name, root_models_path='/data/users/ys221/data/pretrain/HRNet/landmark/hrnetv2_models', prefix='HR18-', model_type='landmarks', device='cuda'):
