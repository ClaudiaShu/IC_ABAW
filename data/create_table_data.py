...
if __name__ == '__main__':
    ...
    dir_save_df_labels = ['/data/users/ys221/data/ABAW/labels_save/expression/',
                          '/data/users/ys221/data/ABAW/labels_save/action_unit/',
                          '/data/users/ys221/data/ABAW/labels_save/valence_arousal/']

    for set_data in ['Train_Set', 'Validation_Set']:
        for i, type_partition in enumerate(['EXPR_Set', 'AU_Set', 'VA_Set']):
            list_txt = glob.glob(
                f'/data/users/ys221/data/ABAW/annotations/annotations/{type_partition}/{set_data}/*')
